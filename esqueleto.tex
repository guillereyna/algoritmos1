...
\pred{posicionesVivas}{t : toroide, vivas : \TLista{\ent \times \ent}}{\\ 
	(\forall i : \ent)((0 \leq i < |vivas|) \implicaLuego t[vivas[i]_0][vivas[i]_1]) \land \\
...
\aux{cantVecinosVivos}{t : toroide, f : \ent , c : \ent}{\ent}{\\
	\sum_{i=0}^{|t|-1}
	\sum_{j=0}^{|t[i]|-1}
	\IfThenElse{t[i][j] \land esVecino(t,i,j,f,c)}{1}{0}}
...
\pred{evolucionDePosiciones}{t : toroide, posicion : $\ent \times \ent$}{\\
	\IfThenElse{t[(posicion)_0][(posicion)_1] \\}
	{2 \leq cantVecinosVivos(t, i, j) \leq 3\\}
	{cantVecinosVivos(t, i, j) = 3}
	\\}

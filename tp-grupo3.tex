...
(\forall i : \ent)((\forall j : \ent)((0 \leq i < \longitud{t} \yLuego 0 \leq j < \longitud{t[i]} \yLuego (i,j) \in vivas) \Iff_L t[i][j] = \True))\\
}
...
evolucionDePosicion(t1, (i,j)) = \True \Iff t2[i][j] = \True\\
}

...
\subsection{Predicados auxiliares}
    ...
    (\forall i : \ent)(1 \leq i \leq k \implicaLuego evolucionToroide(evo[i-1], evo[i])))
    \\}
...
\begin{proc}{esPeriodico}{\In t : toroide, \Inout p : \ent, \Out result : \bool}{}
    \pre{esValido(t)}
    \post{result = \True \leftrightarrow (p > 0 \land kTicksEvolucion(p, t, t))}
\end{proc}
...
\pred{sonPrimos}{t1, t2 : toroide}{\\
    (\exists k : \ent)(k > 0 \land kTicksEvolucion(k, t1, t2))
    \\}
...
\begin{proc}{fusionar}{\In t1 : toroide, \In t2 : toroide, \Out res : toroide}{}
    \pre{esValido(t1) \land esValido(t2) \land mismoTablero(t1, t2)}
    \post{esValido(res) \land esInterseccion(t1, t2, res)}
\end{proc}
...
\begin{proc}{menorSuperficieViva}{\In t : toroide, \Out res : \ent}{}
    \pre{esValido(t)}
    \post{res > 0 \\ 
    \land_L (esMenorSuperficie(t,res) \ \land \ esMenorSuperficieEnTraslacion(t, res))}
\end{proc}
...
\pred{esMenorSuperficie}{t : toroide, res : \ent}{\\
    \neg (\exists i1, i2, j1, j2)((0 \leq i1 < i2 < |t| \land 0 \leq j1 < j2 < |t[0]) \land_L \\
    (esMenorRectangulo(t, i1, i2, j1, j2) \land area(i1, i2, i3, i4) < res))
    \\}
...
\pred{estaCreciendo}{t : toroide}{\\
    ...
    (\exists k, m : \ent)((0 < k < m) \land_L (esMenorSuperficie(t, k) \land esMenorSuperficie(t, m))))
    \\}
